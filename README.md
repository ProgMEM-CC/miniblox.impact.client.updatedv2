...
# [![Impact V8](https://readme-typing-svg.demolab.com?font=Fira+Code&duration=3500&pause=2000&color=FF0000&width=435&lines=Impact+Client+V9+discontinued;Use+Vape+Rewrite;codeberg.org/Miniblox/VapeRewrite;Vape+Rewrite+works+on+latest+Miniblox;and+with+more+games+supported+soon)](https://git.io/typing-svg)
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=14&duration=2500&pause=1000&color=abe0e4&vCenter=true&width=600&lines=Impact+is+now+discontinued;Use+Vape+Rewrite+instead.)](https://git.io/typing-svg)
