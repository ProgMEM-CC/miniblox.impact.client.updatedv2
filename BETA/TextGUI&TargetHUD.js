addModification(
  ...
  /*js*/`
    ...
    if (ctx$5 && enabledModules["TextGUI"]) {
        ...
        const moduleModes = {
          autofunnychat: "Meme", AutoRespawn: "Instant", ChatDisabler: "Packets", NoSlowdown: "Vanilla",
          FilterBypass: "Unicode", NameTags: "Custom", AutoClicker: "RMB", AutoQueue: "Instant",
          ChestSteal: "Hypixel", KeepSprint: "All", InvCleaner: "Normal", AutoArmor: "Smart",
          AutoRejoin: "Delay", LongJump: "Vanilla", AntiCheat: "Bypass", FastBreak: "Instant",
          AutoCraft: "Sword", AutoVote: "SkyWars", MusicFix: "Auto", Scaffold: "MultiBlock",
          Velocity: "Basic", InvWalk: "Normal", AntiBan: "Packet", Breaker: "Egg", Killaura: "Single",
          Speed: "JumpSpeed", NoFall: "Desync", Phase: "Normal", Sprint: "Normal", Jesus: "Vanilla",
          Timer: "Boost", WTap: "Legit", Step: "Vanilla", ESP: "Box", Fly: "Desync", ChinaRing: "FunnyWarz2",
          TargetHUD: "HUD"
        };
